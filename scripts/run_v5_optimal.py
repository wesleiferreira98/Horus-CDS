#!/usr/bin/env python3
"""Setup ótimo combinado: seq_len=16 + lr=3e-4 + patience=20.

Uso:
    cd Horus-CDS && python scripts/run_v5_optimal.py
"""
...
EXPERIMENT_NAME = "exp_optimal"


def main():
    data   = pd.read_csv(CSV_PATH)
    thread = TrainingThreadTransformer(data_set=data, seq_len=16, lr=3e-4, patience=20)

...
export default function Navbar({ theme, onThemeToggle, currentModel, monitoring, onOpenModelModal, onOpenConfigModal }) {
  ...
  return (
    <nav className="sticky top-0 z-40 bg-gray-900 border-b border-gray-800 shadow-lg shadow-black/20">
      <div className="w-full px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <span className="font-bold text-white text-lg tracking-tight hidden sm:block">Hórus-CDS</span>
        ...
        <div className="flex items-center gap-0.5 shrink-0">
          ...
          <button
            ...
            className="hidden sm:block px-3 py-1.5 rounded-lg text-sm text-gray-300 hover:text-white hover:bg-gray-700 transition-colors"
          >
            Relatório
          </button>
          ...
          <button className="hidden sm:block px-3 py-1.5 rounded-lg text-sm text-gray-300 hover:text-white hover:bg-gray-700 transition-colors">
            Sobre
          </button>
        </div>
      </div>
